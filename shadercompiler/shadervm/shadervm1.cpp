...
void CqShaderVM::SO_lsff()
{
	...
	OpLSS_FF( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_lspp()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpLSS_PP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_lscc()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpLSS_CC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_gtff()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpGRT_FF( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_gtpp()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpGRT_PP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_gtcc()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpGRT_CC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_geff()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpGE_FF( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_gepp()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpGE_PP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_gecc()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpGE_CC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_leff()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpLE_FF( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_lepp()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpLE_PP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_lecc()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpLE_CC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_eqff()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpEQ_FF( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_eqpp()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpEQ_PP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_eqcc()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpEQ_CC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_eqss()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpEQ_SS( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_neff()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpNE_FF( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_nepp()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpNE_PP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_necc()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpNE_CC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_ness()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpNE_SS( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_mulff()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpMUL_FF( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_divff()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpDIV_FF( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_addff()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpADD_FF( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_subff()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpSUB_FF( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_divpp()
{
	...
	POPV( B );
	RESULT(type_point, __fVarying?class_varying:class_uniform);
	OpDIV_PP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_addpp()
{
	...
	POPV( B );
	RESULT(type_point, __fVarying?class_varying:class_uniform);
	OpADD_PP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_subpp()
{
	...
	POPV( B );
	RESULT(type_point, __fVarying?class_varying:class_uniform);
	OpSUB_PP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_crspp()
{
	...
	POPV( B );
	RESULT(type_point, __fVarying?class_varying:class_uniform);
	OpCRS_PP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_dotpp()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpDOT_PP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_mulcc()
{
	...
	POPV( B );
	RESULT(type_color, __fVarying?class_varying:class_uniform);
	OpMUL_CC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_divcc()
{
	...
	POPV( B );
	RESULT(type_color, __fVarying?class_varying:class_uniform);
	OpDIV_CC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_addcc()
{
	...
	POPV( B );
	RESULT(type_color, __fVarying?class_varying:class_uniform);
	OpADD_CC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_subcc()
{
	...
	POPV( B );
	RESULT(type_color, __fVarying?class_varying:class_uniform);
	OpSUB_CC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_crscc()
{
	...
	POPV( B );
	RESULT(type_color, __fVarying?class_varying:class_uniform);
	OpCRS_CC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_dotcc()
{
	...
	POPV( B );
	RESULT(type_float, __fVarying?class_varying:class_uniform);
	OpDOT_CC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_mulfp()
{
	...
	POPV( B );
	RESULT(type_point, __fVarying?class_varying:class_uniform);
	OpMUL_FP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_divfp()
{
	...
	POPV( B );
	RESULT(type_point, __fVarying?class_varying:class_uniform);
	OpDIV_FP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_addfp()
{
	...
	POPV( B );
	RESULT(type_point, __fVarying?class_varying:class_uniform);
	OpADD_FP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_subfp()
{
	...
	POPV( B );
	RESULT(type_point, __fVarying?class_varying:class_uniform);
	OpSUB_FP( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_mulfc()
{
	...
	POPV( B );
	RESULT(type_color, __fVarying?class_varying:class_uniform);
	OpMUL_FC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_divfc()
{
	...
	POPV( B );
	RESULT(type_color, __fVarying?class_varying:class_uniform);
	OpDIV_FC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_addfc()
{
	...
	POPV( B );
	RESULT(type_color, __fVarying?class_varying:class_uniform);
	OpADD_FC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_subfc()
{
	...
	POPV( B );
	RESULT(type_color, __fVarying?class_varying:class_uniform);
	OpSUB_FC( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
...
void CqShaderVM::SO_mulmm()
{
	...
	POPV( B );
	RESULT(type_matrix, __fVarying?class_varying:class_uniform);
	OpMUL_MM( A, B, pResult, m_pEnv->RunningState2() );
	Push( pResult );
	RELEASE( B );
	RELEASE( A );
}
